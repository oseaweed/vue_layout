  ...
  <section>
    <mu-content-block style="display:flex;">
      <mu-select-field :value="activeUI" @change="handleTabChange" autoWidth>
        ...
        <mu-menu-item title="Mint-UI" value="Mint-UI"></mu-menu-item>
        <mu-menu-item title="iView-UI" value="iView-UI"></mu-menu-item>
        <mu-menu-item title="Element-UI" value="Element-UI"></mu-menu-item>
        <mu-menu-item title="通用" value="Common"></mu-menu-item>
        <mu-menu-item title="测试" value="Test"></mu-menu-item>
      </mu-select-field>
    ...
    <div v-if="activeUI==='Test'">
      <ul class="components-list">
        <li draggable="true" @dragstart="dragStart" data-name="Button">
          <mu-icon value="text_fields" style="vertical-align:middle;" />Button
        </li>
      </ul>
    </div>
  </section>
